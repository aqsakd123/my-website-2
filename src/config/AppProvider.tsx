...
import { FormConfigItem, FormProvider } from './FormProvider'

const formConfig: FormConfigItem[] = [
  { type: 'customForm1', component: () => <>Custom Form 1</> },
  { type: 'customForm2', component: () => <>Custom Form 2</> },
]
